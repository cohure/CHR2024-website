...
<div class="tabset">
  ...
  <!-- button creation -->
  <!-- TUE -->
  <input type="radio" name="tabset" id="tab-tue" aria-controls="tue" checked>
  <label for="tab-tue">Tuesday</label>
  <!-- WED -->
  <input type="radio" name="tabset" id="tab-wed" aria-controls="wed" checked>
  <label for="tab-wed">Wednesday</label>
  <!-- THUR -->
  <input type="radio" name="tabset" id="tab-thu" aria-controls="thu">
  <label for="tab-thu">Thursday</label>
  <!-- FRI -->
  <input type="radio" name="tabset" id="tab-fri" aria-controls="fri">
  <label for="tab-fri">Friday</label>
  
  <!-- content -->
  <div class="tab-panels">
  <section id="tab-tue" class="tab-panel">
  ...
  <!-- WED -->
    <section id="tab-wed" class="tab-panel">
  ...
  <!-- THUR -->
    <section id="tab-thu" class="tab-panel">
    ...
    <!-- FRI -->
    <section id="tab-fri" class="tab-panel">
